...
S = {
    "S1_interval": {
        ...
        "weight_functions": "\dofs{2}{1}{0}{0}{1} = 2",
    ...
    "S2_interval": {
        ...
        "weight_functions": "\dofs{2}{2}{0}{0}{1} \pl \dofs{1}{0}{1}{1}{1} = 3",
    ...
    "S3_interval": {
        ...
        "weight_functions": "\dofs{2}{3}{0}{0}{1} \pl \dofs{1}{1}{1}{1}{2} = 4",
    ...
    "dPc1_interval": {
        ...
        "weight_functions": "\dofs{1}{1}{0}{1}{2} = 2",
    ...
    "dPc2_interval": {
        ...
        "weight_functions": "\dofs{1}{2}{0}{1}{3} = 3",
    ...
    "dPc3_interval": {
        ...
        "weight_functions": "\dofs{1}{3}{0}{1}{4} = 4",
    ...
    "S1_quadrilateral": {
        ...
        "weight_functions": "\dofs{4}{1}{0}{0}{1} = 4",
    ...
    "S2_quadrilateral": {
        ...
        "weight_functions": "\dofs{4}{2}{0}{0}{1} \pl \dofs{4}{0}{1}{1}{1} = 8",
    ...
    "S3_quadrilateral": {
        ...
        "weight_functions": "\dofs{4}{3}{0}{0}{1} \pl \dofs{4}{1}{1}{1}{2} = 12",
    ...
    "BDMc1_quadrilateral": {
        ...
        "dimension": 8,
        "image": "BDMc1_quadrilateral.png",
        "weight_functions": "\dofs{4}{1}{0}{1}{2} = 8",
    ...
    "BDMc2_quadrilateral": {
        ...
        "dimension": 14,
        "image": "BDMc2_quadrilateral.png",
        "weight_functions": "\dofs{4}{2}{0}{1}{3} \pl \dofs{1}{0}{1}{2}{2} = 14",
    ...
    "BDMc3_quadrilateral": {
        ...
        "dimension": 22,
        "image": "BDMc3_quadrilateral.png",
        "weight_functions": "\dofs{4}{3}{0}{1}{4} \pl \dofs{1}{1}{1}{2}{6} = 22",
    ...
    "dPc1_quadrilateral": {
        ...
        "weight_functions": "\dofs{1}{1}{0}{2}{3} = 3",
    ...
    "dPc2_quadrilateral": {
        ...
        "weight_functions": "\dofs{1}{2}{0}{2}{6} = 6",
    ...
    "dPc3_quadrilateral": {
        ...
        "weight_functions": "\dofs{1}{3}{0}{2}{10} = 10",
    ...
    "S1_hexahedron": {
        ...
        "weight_functions": "\dofs{8}{1}{0}{0}{1} = 8",
    ...
    "S2_hexahedron": {
        ...
        "weight_functions": "\dofs{8}{2}{0}{0}{1} \pl \dofs{12}{0}{1}{1}{1} = 20",
    ...
    "S3_hexahedron": {
        ...
        "weight_functions": "\dofs{8}{3}{0}{0}{1} \pl \dofs{12}{1}{1}{1}{2} = 32",
    ...
    "AAe1_hexahedron": {
        ...
        "weight_functions": "\dofs{12}{1}{0}{1}{2} = 24",
    ...
    "AAe2_hexahedron": {
        ...
        "weight_functions": "\dofs{12}{2}{0}{1}{3} \pl \dofs{6}{0}{1}{2}{2} = 48",
    ...
    "AAe3_hexahedron": {
        ...
        "weight_functions": "\dofs{12}{3}{0}{1}{4} \pl \dofs{6}{1}{1}{2}{6} = 84",
    ...
    "AAf1_hexahedron": {
        ...
        "weight_functions": "\dofs{6}{1}{0}{2}{3} = 18",
    ...
    "AAf2_hexahedron": {
        ...
        "weight_functions": "\dofs{6}{2}{0}{2}{6} \pl \dofs{1}{0}{1}{3}{3} = 39",
    ...
    "AAf3_hexahedron": {
        ...
        "weight_functions": "\dofs{6}{3}{0}{2}{10} \pl \dofs{1}{1}{1}{3}{12} = 72",
    ...
    "dPc1_hexahedron": {
        ...
        "weight_functions": "\dofs{1}{1}{0}{3}{4} = 4",
    ...
    "dPc2_hexahedron": {
        ...
        "weight_functions": "\dofs{1}{2}{0}{3}{10} = 10",
    ...
    "dPc3_hexahedron": {
        ...
        "weight_functions": "\dofs{1}{3}{0}{3}{20} = 20",
