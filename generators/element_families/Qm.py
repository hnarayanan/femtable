...
Qm = {
    "Q1_interval": {
        ...
        "weight_functions": "\dofq{2}{0}{0}{0}{1} = 2",
    ...
    "Q2_interval": {
        ...
        "weight_functions": "\dofq{2}{1}{0}{0}{1} \pl \dofq{1}{1}{1}{1}{1} = 3",
    ...
    "Q3_interval": {
        ...
        "weight_functions": "\dofq{2}{2}{0}{0}{1} \pl \dofq{1}{2}{1}{1}{2} = 4",
    ...
    "dQ0_interval": {
        ...
        "weight_functions": "\dofq{1}{0}{0}{1}{1} = 1",
    ...
    "dQ1_interval": {
        ...
        "weight_functions": "\dofq{1}{1}{0}{1}{2} = 2",
    ...
    "dQ2_interval": {
        ...
        "weight_functions": "\dofq{1}{2}{0}{1}{3} = 3",
    ...
    "Q1_quadrilateral": {
        ...
        "weight_functions": "\dofq{4}{0}{0}{0}{1} = 4",
    ...
    "Q2_quadrilateral": {
        ...
        "weight_functions": "\dofq{4}{1}{0}{0}{1} \pl \dofq{4}{1}{1}{1}{1} \pl \dofq{1}{1}{2}{2}{1} = 9",
    ...
    "Q3_quadrilateral": {
        ...
        "weight_functions": "\dofq{4}{2}{0}{0}{1} \pl \dofq{4}{2}{1}{1}{2} \pl \dofq{1}{2}{2}{2}{4} = 16",
    ...
    "RTc1_quadrilateral": {
        ...
        "dimension": 4,
        "image": "RTc1_quadrilateral.png",
        "weight_functions": "\dofq{4}{0}{0}{1}{1} = 4",
    ...
    "RTc2_quadrilateral": {
        ...
        "dimension": 12,
        "image": "RTc2_quadrilateral.png",
        "weight_functions": "\dofq{4}{1}{0}{1}{2} \pl \dofq{1}{1}{1}{2}{4} = 12",
    ...
    "RTc3_quadrilateral": {
        ...
        "dimension": 24,
        "image": "RTc3_quadrilateral.png",
        "weight_functions": "\dofq{4}{2}{0}{1}{3} \pl \dofq{1}{2}{1}{2}{12} = 24",
    ...
    "dQ0_quadrilateral": {
        ...
        "weight_functions": "\dofq{1}{0}{0}{2}{1} = 1",
    ...
    "dQ1_quadrilateral": {
        ...
        "weight_functions": "\dofq{1}{1}{0}{2}{4} = 4",
    ...
    "dQ2_quadrilateral": {
        ...
        "weight_functions": "\dofq{1}{2}{0}{2}{9} = 9",
    ...
    "Q1_hexahedron": {
        ...
        "weight_functions": "\dofq{8}{0}{0}{0}{1} = 8",
    ...
    "Q2_hexahedron": {
        ...
        "weight_functions": "\dofq{8}{1}{0}{0}{1} \pl \dofq{12}{1}{1}{1}{1} \pl \dofq{6}{1}{2}{2}{1} \pl \dofq{1}{1}{3}{3}{1} = 27",
    ...
    "Q3_hexahedron": {
        ...
        "weight_functions": "\dofq{8}{2}{0}{0}{1} \pl \dofq{12}{2}{1}{1}{2} \pl \dofq{6}{2}{2}{2}{4} \pl \dofq{1}{2}{3}{3}{8} = 64",
    ...
    "Nce1_hexahedron": {
        ...
        "weight_functions": "\dofq{12}{0}{0}{1}{1} = 12",
    ...
    "Nce2_hexahedron": {
        ...
        "weight_functions": "\dofq{12}{1}{0}{1}{2} \pl \dofq{6}{1}{1}{2}{4} \pl \dofq{1}{1}{2}{3}{6} = 54",
    ...
    "Nce3_hexahedron": {
        ...
        "weight_functions": "\dofq{12}{2}{0}{1}{3} \pl \dofq{6}{2}{1}{2}{12} \pl \dofq{1}{2}{2}{3}{36} = 144",
    ...
    "Ncf1_hexahedron": {
        ...
        "weight_functions": "\dofq{6}{0}{0}{2}{1} = 6",
    ...
    "Ncf2_hexahedron": {
        ...
        "weight_functions": "\dofq{6}{1}{0}{2}{4} \pl \dofq{1}{1}{1}{3}{12} = 36",
    ...
    "Ncf3_hexahedron": {
        ...
        "weight_functions": "\dofq{6}{2}{0}{2}{9} \pl \dofq{1}{2}{1}{3}{54} = 108",
    ...
    "dQ0_hexahedron": {
        ...
        "weight_functions": "\dofq{1}{0}{0}{3}{1} = 1",
    ...
    "dQ1_hexahedron": {
        ...
        "weight_functions": "\dofq{1}{1}{0}{3}{8} = 8",
    ...
    "dQ2_hexahedron": {
        ...
        "weight_functions": "\dofq{1}{2}{0}{3}{27} = 27",
